        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            ...
            <div className="ml-6 flex space-x-8">
              <Link to="/recruiter/dashboard" className="text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 border-blue-500 text-sm font-medium">
                Dashboard
              </Link>
            </div>
          </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative ml-3">
                <button className="text-gray-500 hover:text-gray-700 flex items-center focus:outline-none">
                  ...
                  <span className="hidden md:block text-sm mr-2">{recruiter.name}</span>
